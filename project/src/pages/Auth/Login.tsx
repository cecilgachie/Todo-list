      ...
      <div className="max-w-md w-full">
        ...
        >
          ...
          <div className="px-8 pt-8 pb-6 text-center">
            ...
            <p className="text-gray-600">Sign in to your account to continue creating amazing designs</p>
          </div>
          ...
          <div className="px-8 pb-8">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-colors">
